    		...
    		<legend>SSH Client</legend>
    			...
    			if (isset($_SESSION['login'])) {
					...
					if (isset($_GET['id'])) {
						...
						//display form
						echo '<form method="GET" action="linuxSSHMain.php">';
						echo "Command Input";
						echo "<br>";
						echo '<textarea rows="2" cols="80" name="ssh" id="ssh" wrap="physical"></textarea><br>';
